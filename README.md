...
- [Create a new issue](https://github.com/osoc22/technical-support/issues/new/choose) in this repository
...
- I'll assign a [priority](https://github.com/osoc22/technical-support/labels?q=priority) on your request
- I'll take care of your request
- If I need any additional information, I'll contact you **through the issue**

### Triage board

At any time, you'll be able to see the status of your request in the [triage board](https://github.com/osoc22/technical-support/projects/1).
...
If I need more information from you, I'll assign the label [`question`](https://github.com/osoc22/technical-support/labels/question)!  
If I need help from someone else to complete your request, I'll assign the label [`help wanted`](https://github.com/osoc22/technical-support/labels/help%20wanted)!
...
- [Supabase](https://supabase.com/) documentation: <https://supabase.com/docs>
